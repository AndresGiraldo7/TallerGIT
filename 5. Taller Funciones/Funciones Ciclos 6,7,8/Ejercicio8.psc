Proceso sin_titulo
	...
	Repetir
		...
		Segun opcion Hacer
			1:
				Registro(usu1, usu2, usu3, usu4, usu5, usu6,usu7,usu8);
				
			2:
				Consultar(usu1, usu2, usu3, usu4, usu5, usu6,usu7,usu8,nopresentado,presentado);
				
			3:
				Resultados(usu1, usu2, usu3, usu4, usu5, usu6,usu7,usu8,aprobado, noaprobado);
			
		FinSegun
	Hasta Que opcion <> 1 y opcion <> 2 y opcion <> 3;
FinProceso

SubProceso Registro(usu1, usu2, usu3, usu4, usu5, usu6,usu7,usu8)
...
SubProceso Consultar(usu1, usu2, usu3, usu4, usu5, usu6,usu7,usu8,nopresentado,presentado)
...
SubProceso Resultados(usu1, usu2, usu3, usu4, usu5, usu6,usu7,usu8,aprobado, noaprobado)
	Definir usuario Como Caracter;
	Escribir "Dijite el nombre del usuario para ver el resultado de la prueba ";
	Leer usuario;
	Si usuario = usu1 Entonces
